...
function InEquipement() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setError(false);
    const url = 'https://voiture-production-247e.up.railway.app/api/equipement/insert';
    ...
    <div className='pat'>
      <div className='fit'>
        <form onSubmit={handleSubmit} method='post'>
          <label>Nouveau equipement :</label>
          <input
